...
export const galleryItems: GalleryItem[] = [
    ...
    { id: 3,  type: "card",  text: "HACK2DAWN",    time: "16-05", description: "TEC de Monterrey, Edificio negiocios",                               charColor: "#1fffd2", size: "normal", orientation: "horizontal", scrollSpeed: 1 },
